...
export class Algorithms extends React.Component {
  ...
  approveRejectOnClick(e) {
    ...
    dispatch(
      approveOrRejectSubmission(submissionid, approve, this.props.challengeId)
    );
    linkOnClick(e);
  }
  ...
  sortData() {
    ...
    try {
      if (sortAttr === "Date Submitted") {
        ...
        const sortIdx =
          parseInt(this.props.dataIdx) - this.ALGO_SORT_OPTIONS.length;
        sortedData.sort(function (x, y) {
      ...
      <div>
        <div className="overview">
          <div className="overview-description">
            Each panel shows results for a different algorithm. Click a panel to
            see more info. Columns are scores, and rows are datasets.
          </div>
