      ...
      (a.jstree.core.prototype = {
        ...
        create_node: function (c, d, e, f, g) {
          ...
          for (
            ...
            this._model.data[c.parents[j]].children_d = this._model.data[
              c.parents[j]
            ].children_d.concat(i);
        ...
        move_node: function (c, d, e, f, g, h, i) {
          ...
          if (c.parent === n.id) {
            ...
            for (
              ...
              this._model.data[n.parents[s]].children_d = this._model.data[
                n.parents[s]
              ].children_d.concat(r);
        ...
        copy_node: function (c, d, e, f, g, h, i) {
          ...
          for (
            ...
            this._model.data[r.parents[n]].children_d = this._model.data[
              r.parents[n]
            ].children_d.concat(l);
        ...
        (this.bind = function () {
              ...
              this.element
                .on(
                  ...
                  a.proxy(function (b, c) {
                    ...
                    this._data[
                      o ? "core" : "checkbox"
                    ].selected = a.vakata.array_unique(
                    ...
                    while (h && h.id !== a.jstree.root) {
                      ...
                      if (i === k)
                        ...
                        (h.state[m ? "selected" : "checked"] = !1),
                          (this._data[
                            m ? "core" : "checkbox"
                          ].selected = a.vakata.array_remove_item(
                  ...
                  .each(function () {
                    ...
                    if (i)
                      if (i.state.loaded) {
                        ...
                        i.original.state.undetermined === !0
                      )
                        for (
                          g[i.id] === b &&
                            i.id !== a.jstree.root &&
                            ((g[i.id] = !0), k.push(i.id)),
                            e = 0,
                            f = i.parents.length;
                          f > e;
                          e++
                          ...
                          g[i.parents[e]] === b &&
                            i.parents[e] !== a.jstree.root &&
                            ((g[i.parents[e]] = !0), k.push(i.parents[e]));
                  }),
                  this.element
          ...
          (this._cascade_new_checked_state = function (a, b) {
            ...
            if (
              ...
              e.state[d ? "selected" : "checked"] && h.push(e.id),
                (f = f.concat(h));
            } else {
              e.children &&
              ...
              e.original &&
                ...
                (e.original.state.undetermined = j),
                j
          ...
          this.element
            ...
            .on("touchmove.vakata.jstree", function (a) {
              c &&
                ...
                (Math.abs(e - a.originalEvent.changedTouches[0].clientX) > 50 ||
                  Math.abs(f - a.originalEvent.changedTouches[0].clientY) >
                    50) &&
                clearTimeout(c);
            })
