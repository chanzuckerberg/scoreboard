      ...
      if (
        ...
        if (node.children) {
          node.children.forEach(function (childId) {
            var selectedChildIds = self._cascade_new_checked_state(
              childId,
              checkedState
            );
      ...
      this.element
        ...
        .on("touchmove.vakata.jstree", function (e) {
          if (
            ...
            e.originalEvent.changedTouches &&
            e.originalEvent.changedTouches[0] &&
            (Math.abs(ex - e.originalEvent.changedTouches[0].clientX) > 50 ||
              Math.abs(ey - e.originalEvent.changedTouches[0].clientY) > 50)
          ) {
            clearTimeout(cto);
          }
        })
